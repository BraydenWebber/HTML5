    ...
    if(choice == "hopefully monkeys" || choice == "hm"){
        ...
        if(garden == "throw a rock at the ant" ||garden == "tarata"){
            ...
            alert("The ant was so excited to see an unfamiliar face! He welcomed you with a warm welcome and asked you to hear him out. It seemed like he hadn't talked to someone who wasn't an ant in years.")
                ...
                if (antking == "leave the ant" || antking == "lta"){
                    ...
                    if(listening == "leave the ant king" || listening == "ltak"){
                        ...
                        if(staylistening == "leave him" || staylistening == "lh"){
                            alert("Deciding to leave the king was probably a good idea. He could have rambled on forever... He was however very upset about you cutting him off but he understood. He should you the way out of the garden and a easy way to the monkey forest.");
                        Monkey();
                        }
      ...
      function Cave{
          ...
          if(markings == "look around" || markings == "la"){
          ...
          else if(markings == "try to make sense of the symbols" || markings == "ttmsots"){
              ...
              if(game == "the laughing smile" || "tls"){
      ...
      function Cat{
          ...
          if(lost == "pick a direction" || lost == "pad"){
              ...
              else if(catslaugh == "go for the eye" || catslaugh == "eye" || catslaugh == "eyes" || catslaugh == "cats eyes"){
      ...
      function Fancy{
          ...
          if(castle == "go with the lion" || castle == "gwtl" || castle == "go with lion"){
          ...
          else if(castle == "explore on your own" || castle == "eoyw"){
              alert("The lion lays down to make it easier for you to climb off of his back to explore the castle on your own.");
              alert("The castle was cold and felt much like the fancy fall way. There were red carpeting and red banners hanging down from the ceiling. At one end you could see a painting of a queen. She cleerly had an obssesion with the color red being as that's every color she was wearing. She did however look quite fair just really pale like paper white.");
              ...
              if(castlehall == "stairway" || castlehall == "s"){
                  alert("The stairs actually were harder to walk up than they should have been. The stairs started to move around with each step you took. Sometimes you had to completly leap up to make it to the next step.");
                  ...
                  alert("You open the glass door and see the bigger picture. There is a house in the middle of all the flowers and other varias floral things. There is a nice beautiful foutian of stone fish spitting water out of there mouths. Upon closer examination you see that the heads of the fishes are actually bee heads. The whole thing looks a lot weirder now.");
...
function Trapdoor{
    ...
    if(madman == "examine the man" || madman == "etm"){
        alert("The madman was deffinitly crazy and very frightened of you. You noticed that he had a wooden left arm that didn't seem completly functionable. He was also wearing a chain around his neck with a bright yellow cats eye on it. The man was very tall and starch white much like the queen except this one seemed a lot less natrueal. Almost like he used make up.");
        var pacify = prompt("The closer you stepped to the man the easeir it was to see you. The man saw that you were someone he never met before and grew a bit of courage. He looked more comfortable than he did before he adressed you and told you that he was a hatter. In fact he went on for about a hlaf hour about how he was the best hatter but everyone thought of him as to mad to truly appreciate his talent. The only person who truly appreciated him was the red queen but he wanted more. \n - red queen \- weird ladder");
        if(pacify == "weird ladder" || pacify == "wl"){
            alert("What the weird later? That's what you are interested in!? Fine fine whatever it doesn't matter... No one wants to hear the long story of my fearsom battle with the cat of the woods... The weird ladder was made so i couldn't leave. If you didn't see already my whole left arm is a barely functioning wooden arm that I would normally use to climb out. But sense the ladder requires that you use all of your limbs I just simpily can't leave. However I am premitted to leave but only for the tournament that the queen holds annually. Speaking about that you better get going it should start soon! You know if you're caught outside of the event you are sentenced to death...");
            alert("The madman quickly shows you to the ladder and tells you were to go to the tournament. You quickly hurry down there.");
            Tournament();
        }
       else if(pacify == "red queen" || pacify == "rq"){
            alert("Oh you don't know the red queen? the man said. Well that actually isn't to much of a suprise because the whole kigdom has been demanded to never speak of her. Punishable by death... Seeing as I'm already trapped down here and my only role is to make hats for her... I don't really care about the consequences...");
            alert("The queen is this evil tyrant who asks like shes caring and ccompassionate but she does cruel things like trap a hatter in a basement. Or randomly exacute people. She holds all the power and if anybody dare stand up to her they are sure to meet there demise... She is evil. It is said that she is so uptight that the blood from her body literally leaked out of her leaving her paper white. She than commanded anyone in her castle to paint themselves white in hopes that nobody would notice the whitness of her. She's evil! but hey what are you going to do?");
            alert("Wait a second... You arent a spy are you!? You weren't sent hear to see how I would handle this whole situation were you?? Listen I didn't mean anything about anything what do I know I'm clearly mad... haha you best be on your way now... Besides the games are about to start so please leave.");
...
function Frontdoor{
    ...
    if(mouse == "attack the mouse" || mouse == "atm"){
        ...
        alert("The mouse stopped her atttack and instead just looked at you. She seemed disapointed.");
        ...
        else if(mouse == "leave to the tournament" || mouse == "lttt"){
            alert("You relize that you don't know the directions to the tournament so you ask to be shown the way and the exacutioner be grudgingly shows you the path");
            Tournament();
        }
    }
}
...
function End{
    ...
    if(cavein == "give up" || cavein == "gu"){
        alert("To know suprise the queen walked over with her grate long sword and swung directly through you. Slicing off your head completly... Game over...");
        End();
    }
    else if(cavein == "fight the queen" || cavein == "ftq"){
        alert("The queen starts walking towards you and you shoot her a feirce look with a burning fire! The queen taken back by this is only angrier with you. She starts walking faster. Her sword sparking against the floor as she walks. She yells across the floor GIVE UP!!!");
        var giveup = prompt("\n - give up now \n - keep going");
        if(giveup == "give up now" || "gun"){
            alert("To know suprise the queen walked over with her grate long sword and swung directly through you. Slicing off your head completly... Game over...");
        End();
        }
