        ...
        if(decide == "take pipe" || decide == "tp"){
            ...
            if(Decide == "enter" || Decide == "e" ){
                ...
                if(Enter == "sit down with them" || Enter == "sdwt"){
                    ...
                    else if(Sit == "continue with the party" || Sit == "continue" || Sit == "cwtp"){
                        var bored = prompt("Sara yells, lets get this party started! and pulls out a bored game from her backpack. At the same time Jeremy pulls one out of his bag. Somehow in all the commotion they leave you to pick whos bored game to play... \n - play saras game \n - play jeremys game")
                        
                        if (bored == "play saras game" || bored == "psg"){
                            alert("Sara brought Candy Land o the party! You had a nice enjoyable time at the party and went home happy. The end");
                }
                        else if (bored == "play jeremys game" || bored == "pjg"){
