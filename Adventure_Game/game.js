...
switch(outside){
   ...
   /*     
    ...
    case "sit down with them":
        prompt("You decide to sit down with the group and decide to sit next to Jeremy. He slowly introduces you to the group. Out of the six of you (including you) there are 3 girls and 2 guys. There is Sara, Jeremys girlfriend, brooklyn, Mei, Jackson and Tyler. \n - Look at (put name)
    ...
    case "look at Jeremy":
        alert("Jeremy looks up at you as you you look at him. He just smiles that friendly smile that you've known since elementary school. He's a cool guy and you have a lot of respect for him.);
        
    case "continue with the party":
        prompt("Sara yells, "let's get this party started!" and pulls out a bored game from her backpack. At the same time Jeremy pulls one out of his bag. Somehow in all the commotion they leave you to pick whos bored game to play... \n - play sara's game )
