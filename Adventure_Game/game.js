...
function Cave(){
    ...
    if(markings == "try to make sense of the symbols" || markings == "ttmsots"){
        ...
        else if(yelloweyes == "move the curtian" || yelloweyes == "mtc"){
...
function Trapdoor(){
    ...
    if(madman == "yell at the man" || madman == "yatm"){
        alert("The man shreiked and hid behind a stool. Still clearly visble to him you kept yelling. Yelling louder and louder much of it not even making sense. The man soon noticed and got the courage to charge you. He shoved you into the stone wall behind you. Killing you almost instantly... The madman than sat and cried. Game over you horrible monster");
        Trapdoor();
    }
